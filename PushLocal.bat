...
c:\exe\nuget add .\Cadmus.Export\bin\Debug\Cadmus.Export.9.0.0.nupkg -source C:\Projects\_NuGet
c:\exe\nuget add .\Cadmus.Export.ML\bin\Debug\Cadmus.Export.ML.9.0.0.nupkg -source C:\Projects\_NuGet
