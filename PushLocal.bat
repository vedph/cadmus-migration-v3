...
c:\exe\nuget add .\Cadmus.Export\bin\Debug\Cadmus.Export.8.0.12.nupkg -source C:\Projects\_NuGet
c:\exe\nuget add .\Cadmus.Export.ML\bin\Debug\Cadmus.Export.ML.8.0.12.nupkg -source C:\Projects\_NuGet
